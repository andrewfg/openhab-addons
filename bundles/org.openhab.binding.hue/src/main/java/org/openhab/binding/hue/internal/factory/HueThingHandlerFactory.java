...
import org.openhab.binding.hue.internal.clip2.discovery.Clip2ThingDiscoveryService;
import org.openhab.binding.hue.internal.clip2.handler.Clip2BridgeHandler;
import org.openhab.binding.hue.internal.clip2.handler.ResourceThingHandler;
...
public class HueThingHandlerFactory extends BaseThingHandlerFactory {
    ...
    public HueThingHandlerFactory(final @Reference HttpClientFactory httpClientFactory,
        ...
        } else if (HueBindingConstants.THING_TYPE_UID_RESOURCE.equals(thingTypeUID)) {
