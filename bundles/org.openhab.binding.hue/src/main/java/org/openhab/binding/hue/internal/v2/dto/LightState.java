...
/**
 * Base DTO object extended with light specific action elements.
 *
 * @author Andrew Fiddian-Green - Initial contribution
 */
@NonNullByDefault
public class LightState extends BaseResource {
    ...
    public void setAlert(Command command) {
        if (command instanceof StringType) {
            alert = alert != null ? alert : new Alerts();
            // TODO
        }
    }
    ...
    public void setEffect(Command command) {
        if (command instanceof OnOffType) {
            effects = effects != null ? effects : new Effects();
            // TODO
        }
    }
    ...
    public void setTimedEffect(Command command) {
        if (command instanceof OnOffType) {
            timed_effects = timed_effects != null ? timed_effects : new Effects();
            // TODO
        }
    }
