 ...
 */
@NonNullByDefault
public class DlmsHandler extends BaseThingHandler {
    ...
    public DlmsHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        ...
        config = getConfigAs(DlmsConfiguration.class);
                    ...
                    if (result.getResultCode() == AccessResultCode.SUCCESS) {
                        ...
                        try {
                            ...
                            if (unit.isCompatible(Units.AMPERE)) {
                                ...
                                channelTypeUID = DlmsBindingConstants.GENERIC_CHANNEL_UID;
                            }
