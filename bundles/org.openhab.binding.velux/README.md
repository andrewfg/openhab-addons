...
The binding asks each device in the hub if it supports a vane position, and if so, it automatically adds the `vanePosition` channel to the respective Thing.
